 ...
 */
final class Version20240327132648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenu_panier (id INT AUTO_INCREMENT NOT NULL, panier_id INT DEFAULT NULL, qquantite INT NOT NULL, date DATE NOT NULL, UNIQUE INDEX UNIQ_80507DC0F77D927C (panier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, user_panier_id INT NOT NULL, date_achat DATE DEFAULT NULL, etat TINYINT(1) NOT NULL, INDEX IDX_24CC0DF2F79D1F98 (user_panier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
